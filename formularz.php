                    ...
                    <div class="col-7" id="col-7-1">
                        <table>
                            <tr>
                                ...
                                <td style="padding-top: 0px;"><input type="text" name="name" id="name" required maxlength="20"></td>
                            </tr>
                            <tr>
                                <td>LastName:</td> 
                                <td><input type="text" name="lastName" id="lastName" required maxlength="20"></td>
                            </tr>
                        </table>
                        <table>
                            <tr>
